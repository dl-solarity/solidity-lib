...
abstract contract AbstractCompoundRateKeeper is ICompoundRateKeeper, Initializable {
     ...
     */
    function getCapitalizationRate() external view returns (uint256 capitalizationRate_) {
     ...
     */
    function getCapitalizationPeriod() external view returns (uint64 capitalizationPeriod_) {
     ...
     */
    function getLastUpdate() external view returns (uint64 lastUpdate_) {
        return _lastUpdate;
    }
     ...
     */
    function getIsMaxRateReached() external view returns (bool isMaxRateReached_) {
     ...
     */
    function getCurrentRate() external view returns (uint256 currentRate_) {
        return _currentRate;
    }
