...
library EndianConverter {
    ...
    /**
     * @notice Converts big-endian bytes2 to little-endian uint16
    ...
    /**
     * @notice Converts big-endian bytes4 to little-endian uint32
    ...
    /**
     * @notice Converts big-endian bytes8 to little-endian uint64
    ...
    /**
     * @notice Converts big-endian bytes16 to little-endian uint128
    ...
    /**
     * @notice Converts big-endian bytes32 to little-endian uint256
    ...
    /**
     * @notice Converts little-endian bytes2 to big-endian uint16
     * @param input_ The bytes2 to convert
    ...
    /**
     * @notice Converts little-endian bytes4 to big-endian uint32
     * @param input_ The bytes4 to convert
    ...
    /**
     * @notice Converts little-endian bytes8 to big-endian uint64
     * @param input_ The bytes8 to convert
    ...
    /**
     * @notice Converts little-endian bytes16 to big-endian uint128
     * @param input_ The bytes16 to convert
    ...
    /**
     * @notice Converts little-endian bytes32 to big-endian uint256
     * @param input_ The bytes32 to convert
    ...
    /**
     * @notice Converts big-endian uint16 to little-endian bytes2
     * @param input_ The uint16 to convert
     * @return The bytes2 in little-endian encoding
     */
    function uint16BEtoBytes2LE(uint16 input_) internal pure returns (bytes2) {
        return bytes2(_reverseUint16(input_));
    }

    /**
     * @notice Converts big-endian uint32 to little-endian bytes4
     * @param input_ The uint32 to convert
     * @return The bytes4 in little-endian encoding
     */
    function uint32BEtoBytes4LE(uint32 input_) internal pure returns (bytes4) {
        return bytes4(_reverseUint32(input_));
    }

    /**
     * @notice Converts big-endian uint64 to little-endian bytes8
     * @param input_ The uint64 to convert
     * @return The bytes8 in little-endian encoding
     */
    function uint64BEtoBytes8LE(uint64 input_) internal pure returns (bytes8) {
        return bytes8(_reverseUint64(input_));
    }

    /**
     * @notice Converts big-endian uint128 to little-endian bytes16
     * @param input_ The uint128 to convert
     * @return The bytes16 in little-endian encoding
     */
    function uint128BEtoBytes16LE(uint128 input_) internal pure returns (bytes16) {
        return bytes16(_reverseUint128(input_));
    }

    /**
     * @notice Converts big-endian uint256 to little-endian bytes32
     * @param input_ The uint256 to convert
     * @return The bytes32 in little-endian encoding
     */
    function uint256BEtoBytes32LE(uint256 input_) internal pure returns (bytes32) {
        return bytes32(input_.reverseBytes());
    }

    /**
     * @notice Converts little-endian uint16 to big-endian bytes2
     * @param input_ The uint16 to convert
     * @return The bytes2 in big-endian encoding
     */
    function uint16LEtoBytes2BE(uint16 input_) internal pure returns (bytes2) {
        return bytes2(_reverseUint16(input_));
    }

    /**
     * @notice Converts little-endian uint32 to bige-endian bytes4
     * @param input_ The uint32 to convert
     * @return The bytes4 in big-endian encoding
     */
    function uint32LEtoBytes4BE(uint32 input_) internal pure returns (bytes4) {
        return bytes4(_reverseUint32(input_));
    }

    /**
     * @notice Converts little-endian uint64 to big-endian bytes8
     * @param input_ The uint64 to convert
     * @return The bytes8 in big-endian encoding
     */
    function uint64LEtoBytes8BE(uint64 input_) internal pure returns (bytes8) {
        return bytes8(_reverseUint64(input_));
    }

    /**
     * @notice Converts little-endian uint128 to big-endian bytes16
     * @param input_ The uint128 to convert
     * @return The bytes16 in big-endian encoding
     */
    function uint128LEtoBytes16BE(uint128 input_) internal pure returns (bytes16) {
        return bytes16(_reverseUint128(input_));
    }

    /**
     * @notice Converts little-endian uint256 to big-endian bytes32
     * @param input_ The uint256 to convert
     * @return The bytes32 in big-endian encoding
     */
    function uint256LEtoBytes32BE(uint256 input_) internal pure returns (bytes32) {
        return bytes32(input_.reverseBytes());
    }
