...
import "../../../libs/arrays/PaginatorLite.sol";

contract PaginatorLiteMock {
    using PaginatorLite for uint256[];
    using PaginatorLite for address[];
    using PaginatorLite for bytes32[];
    using PaginatorLite for EnumerableSet.UintSet;
    using PaginatorLite for EnumerableSet.AddressSet;
    using PaginatorLite for EnumerableSet.Bytes32Set;
